...
-(void)testCalcluateVertexsForCenter {
    ...
    CC3Vector * array = [LineDrawer calcluateVertexsForCenter:center direction:dir height:height width:width];
...
- (void)testCalculateVertexsForRectangle {
    ...
    CC3Vector * array = [LineDrawer calculateVertexsForRectangleFrom:&start To:&to width:width];
